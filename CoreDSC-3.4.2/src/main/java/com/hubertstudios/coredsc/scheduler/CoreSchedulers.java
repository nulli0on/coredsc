...
/** Selects the Paper/Folia scheduler API while retaining a Spigot fallback. */
public final class CoreSchedulers {
    ...
    public static CoreScheduler create(JavaPlugin plugin) {
        ...
        // Keep Paper-only symbols out of this selector's signatures so the
        // Spigot fallback can still load on servers without Paper classes.
        try {
