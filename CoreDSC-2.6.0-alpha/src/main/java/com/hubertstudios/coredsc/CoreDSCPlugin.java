...
public final class CoreDSCPlugin extends JavaPlugin {
        ...
        switch (subcommand) {
            ...
            case "webeditor" -> {
                ...
                if (!(sender instanceof ConsoleCommandSender)
                    ...
                    sender.sendMessage("§cWebEditor alpha can only be managed from the local server console; RCON is rejected.");
                    return true;
                }
    ...
    private static String moduleForFeature(String feature) {
        ...
        return switch (feature) {
            ...
            case "web_editor_session", "web_editor_save" -> "web-editor";
            default -> null;
        };
    }
